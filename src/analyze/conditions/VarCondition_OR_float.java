...
public class VarCondition_OR_float extends VarCondition {

    public float[] ar;

//    public String name_used_only_for_macroMetric;

    public VarCondition_OR_float(ConditionDetails conditionDetails) throws MyComparator.BadComparatorSymbol {
