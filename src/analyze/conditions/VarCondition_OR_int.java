...
public class VarCondition_OR_int extends VarCondition {

    public int[] ar;

    public VarCondition_OR_int(ConditionDetails conditionDetails)  throws MyComparator.BadComparatorSymbol {
