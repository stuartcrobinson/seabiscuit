...
public class Subcondition_int extends Subcondition {

    int boundary;
    MyComparator c;

    public Subcondition_int(SubconditionText subcon, Var.Type arrayDataType)  throws MyComparator.BadComparatorSymbol {
	this.boundary = Integer.parseInt(subcon.boundaryStr.trim());
