...
public class VarCondition_AND_boolean extends VarCondition {

    private boolean[] ar;

    public VarCondition_AND_boolean(ConditionDetails conditionDetails) throws MyComparator.BadComparatorSymbol {
